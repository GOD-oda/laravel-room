  ...
  <div class="row">
    ...
    <div class="row">
      <div class="input-field col s12 m6">
        ...
        {!! Form::label('url', 'サイトURL', ['for' => 'icon-prefix']) !!}
      </div>
    </div>
    <div class="row">
      <div class="input-field col s12 m6">
        ...
        {!! Form::label('title', '件名', ['for' => 'icon-prefix']) !!}
      </div>
    </div>
    <div class="row">
      <div class="input-field col s12">
        <i class="material-icons prefix">textsms</i>
        {!! Form::textarea('body', null, ['class' => 'materialize-textarea', 'id' => 'editor', 'row' => 5]) !!}
        {!! Form::label('body', '本文', ['for' => 'icon-prefix']) !!}
      </div>
    </div>
    <div class="row">
