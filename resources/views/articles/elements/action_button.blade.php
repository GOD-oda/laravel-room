<div class="container">
  <div class="fixed-action-btn" style="bottom: 45px; right: 24px; display: none;">
    ...
    <ul>
      ...
      <li><a href="{{ url('/') }}" class="btn-floating waves-effect waves-light green"><i class="material-icons">home</i></a></li>
      <li><a href="{{ url('contact') }}" class="btn-floating waves-effect waves-light green"><i class="material-icons">contact_mail</i></a></li>
    </ul>
  </div>
</div>