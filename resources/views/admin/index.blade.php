      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="{{ action('AdminController@show', [$article->id]) }}"><i class="material-icons left">details</i>詳細</a></td>
            <td><a href="{{ action('AdminController@edit', [$article->id]) }}"><i class="material-icons left">edit</i>編集</a></td>
